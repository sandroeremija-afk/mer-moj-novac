...
test('evaluation cycle 2: eight-step static state keeps senior-friendly controls', () => {
  assert.match(html, /id="onboardingProgress"[^>]*>Korak 1 od 8<\/span>/);
  assert.match(css, /\.onboarding-progress-track i\s*\{[^}]*width:calc\(100% \/ 8\)/);
