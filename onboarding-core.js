(function exposeMerOnboardingCore(root, factory) {
  ...
  const DEFAULT_STEPS = Object.freeze([
    ...
    {
      id:'insights', view:'insights', target:'#insightsView', mobileTarget:'#insightsView', contextTarget:'.nav-item[data-view="insights"]', preserveScroll:true, placement:'bottom', titleKey:'onboardingInsightsTitle', bodyKey:'onboardingInsightsBody',
